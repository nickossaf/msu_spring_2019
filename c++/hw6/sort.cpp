...
// решение: сортировка пузырьком(очень медленно, да, зато реализация быстрая), один поток читает, а второй выводит; 
// выводим не в бинарный файл, т.к. про формат нового файла в условии ничего не сказано;
